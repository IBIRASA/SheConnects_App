      ...
      <div className="relative z-10 flex flex-col items-center h-full">
        ...
        <div className="w-full max-w-4xl p-8 bg-transparent bg-opacity-90 rounded-lg" data-aos="fade-up">
          <div className="flex flex-col items-center mb-8">
            <p className="text-gray-100 text-5xl font-medium mb-4">Register</p>
          </div>
          <div className="w-full max-w-md mx-auto">
            <form className="w-full" onSubmit={handleSubmit}>
              ...
              <br />
              <button type="submit" className="bg-gray-200 hover:bg-rose-300 text-rose-700 font-bold py-2 px-4 rounded mt-8" data-aos="fade-up">
                Register
              </button>
            </form>
          </div>
